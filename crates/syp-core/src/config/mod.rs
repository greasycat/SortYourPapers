...
pub struct AppConfig {
    ...
    pub placement_assistance: PlacementAssistance,
    pub placement_mode: PlacementMode,
    pub placement_reference_top_k: usize,
    pub placement_candidate_top_k: usize,
    pub placement_min_similarity: f32,
    pub placement_min_margin: f32,
    pub placement_min_reference_support: usize,
    pub rebuild: bool,
    pub dry_run: bool,
...
pub fn shared_testset_cache_dir() -> Result<PathBuf> {
    xdg::shared_testset_cache_dir()
}
