...
pub(crate) async fn synthesize_categories_with_progress<F>(
    client: &dyn LlmClient,
    preliminary_pairs: &[PreliminaryCategoryPair],
    category_depth: u8,
    taxonomy_batch_size: usize,
...
pub(crate) async fn synthesize_category_batches_with_progress<F>(
    client: &dyn LlmClient,
    preliminary_pairs: &[PreliminaryCategoryPair],
    category_depth: u8,
    taxonomy_batch_size: usize,
...
pub(crate) async fn merge_category_batches(
    client: &dyn LlmClient,
